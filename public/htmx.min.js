(function(e, t) {
  ...
  return function() {
    ...
    function v(e) {
      ...
      if (e.slice(-1) == "m") return parseFloat(e.slice(0, -1)) * 1e3 * 60 || undefined;
    ...
    function h(e, t) {
      var r = e.matches || e.matchesSelector || e.msMatchesSelector || e.mozMatchesSelector || e.webkitMatchesSelector
        || e.oMatchesSelector;
      return r && r.call(e, t);
    }
    function H(e) {
    ...
    function r(e) {
      var t = e.trim();
      if (t.startsWith("<") && t.endsWith("/>")) return t.substring(1, t.length - 2);
      else return t;
    }
    function _(e, t) {
      if (t.indexOf("closest ") === 0) return [d(e, r(t.substr(8)))];
      else if (t.indexOf("find ") === 0) return [b(e, r(t.substr(5)))];
      else if (t.indexOf("next ") === 0) return [W(e, r(t.substr(5)))];
      else if (t.indexOf("previous ") === 0) return [oe(e, r(t.substr(9)))];
      else if (t === "document") return [document];
      else if (t === "window") return [window];
      else return J().querySelectorAll(r(t));
    }
    var W = function(e, t) {
    ...
    function re(e, t) {
      if (t) return _(e, t)[0];
      else return _(J().body, e)[0];
    }
    function s(e) {
      if (A(e, "String")) return b(e);
      else return e;
    }
    function se(e, t, r) {
      if (N(t)) return { target: J().body, event: e, listener: t };
    ...
    function de(e) {
      var t = Z(e, "hx-target");
      if (t) {
        if (t === "this") return he(e, "hx-target");
        else return re(e, t);
      } else {
        var r = Y(e);
    ...
    function ge(t, r) {
      Q(t.attributes, function(e) {
        if (!r.hasAttribute(e.name) && ve(e.name)) t.removeAttribute(e.name);
      });
      Q(r.attributes, function(e) {
        if (ve(e.name)) t.setAttribute(e.name, e.value);
      });
    }
    function pe(e, t) {
      var r = wr(t);
    ...
    function a(e, t, r, n) {
      ...
      while (r.childNodes.length > 0) {
        ...
        e.insertBefore(i, t);
        if (i.nodeType !== Node.TEXT_NODE && i.nodeType !== Node.COMMENT_NODE) n.tasks.push(we(i));
      }
    }
    function Ee(e, t) {
      var r = 0;
    ...
    function Re(t) {
      ...
      if (r.webSocket) r.webSocket.close();
      if (r.sseEventSource) r.sseEventSource.close();
      if (r.listenerInfos) {
    ...
    function Oe(e, t, r) {
      if (e.tagName === "BODY") return Ne(e, t, r);
      else {
        var n;
    ...
    function ke(e, t, r, n, i) {
      switch (e) {
        ...
        default:
              ...
              if (l) {
                if (typeof l.length !== "undefined") {
                  for (var u = 0; u < l.length; u++) {
                    var f = l[u];
                    if (f.nodeType !== Node.TEXT_NODE && f.nodeType !== Node.COMMENT_NODE) i.tasks.push(we(f));
                  }
                }
                return;
              }
          ...
          if (e === "innerHTML") Ne(r, n, i);
          else ke(z.config.defaultSwapStyle, t, r, n, i);
      }
    }
    function Pe(e) {
    ...
    function _e(e, t, r) {
      if (t[0] === "[") {
        ...
        while (t.length > 0) {
          ...
          if (Ve(o, a, r)) i += "((" + r + "." + o + ") ? (" + r + "." + o + ") : (window." + o + "))";
          else i = i + o;
          a = t.shift();
        }
      }
        ...
        do {
          ...
          if (a !== "") {
            if (a === "every") {
              ...
              r.push(o);
            } else if (a.indexOf("sse:") === 0) r.push({ trigger: "sse", sseEvent: a.substr(4) });
            else {
              var l = { trigger: a };
              var s = _e(e, n, "event");
              ...
              while (n.length > 0 && n[0] !== ",") {
                ...
                if (u === "changed") l.changed = true;
                  ...
                  n.shift();
                  l[u] = m(n, g);
                } else ne(e, "htmx:syntax:error", { token: n.shift() });
              }
              r.push(l);
            }
          }
          if (n.length === i) ne(e, "htmx:syntax:error", { token: n.shift() });
          m(n, p);
        } while (n[0] === "," && n.shift());
      }
      if (r.length > 0) return r;
      else if (h(e, "form")) return [{ trigger: "submit" }];
      else if (h(e, "input[type=\"button\"]")) return [{ trigger: "click" }];
      else if (h(e, We)) return [{ trigger: "change" }];
    ...
    function Ge(e, t, r) {
      ...
      n.timeout = setTimeout(function() {
        if (ee(e) && n.cancelled !== true) {
          if (!Qe(r, Lt("hx:poll:trigger", { triggerSpec: r, target: e }))) t(e);
          Ge(e, t, r);
        }
      }, r.pollInterval);
    }
    ...
    function Ke(e, t) {
      if (e.type === "submit" || e.type === "click") {
        ...
        if (
          t.tagName === "A" && t.href && (t.getAttribute("href") === "#" || t.getAttribute("href").indexOf("#") !== 0)
        ) return true;
      }
      return false;
    }
    ...
    function et(i, a, e, o, s) {
      var l = Y(i);
      var t;
      if (o.from) t = _(i, o.from);
      else t = [i];
      if (o.changed) l.lastValue = i.value;
      Q(t, function(r) {
        var n = function(e) {
          if (!ee(i)) {
          ...
          if (t.handledFor.indexOf(i) < 0) {
            t.handledFor.push(i);
            if (o.consume) e.stopPropagation();
            if (o.target && e.target) if (!h(e.target, o.target)) return;
            if (o.once) {
              if (l.triggeredOnce) return;
              else l.triggeredOnce = true;
            }
            if (o.changed) {
              if (l.lastValue === i.value) return;
              else l.lastValue = i.value;
            }
            if (l.delayed) clearTimeout(l.delayed);
            if (l.throttle) return;
            if (o.throttle) {
              if (!l.throttle) {
                a(i, e);
    ...
    function lt(u) {
      ...
      if (f) {
        u.addEventListener(ze(u)[0].trigger, function(e) {
          ...
          if (Ke(e, u)) e.preventDefault();
        });
      } else ne(u, "htmx:noWebSocketSourceError");
    }
    function ut(e) {
    ...
    function ft(e, t, r) {
      ...
      for (var i = 0; i < n.length; i++) {
        var a = n[i].split(/:(.+)/);
        if (a[0] === "connect") ct(e, a[1]);
        if (a[0] === "swap") ht(e, a[1]);
      }
    }
    function ct(t, e) {
    ...
    function ht(a, o) {
      ...
      } else ne(a, "htmx:noSSESourceError");
    }
    function dt(e, t, r) {
      var n = c(e, gt);
      if (n) {
      ...
      } else ne(e, "htmx:noSSESourceError");
    }
    function vt(e) {
      if (!ee(e)) {
    ...
    function xt(n, e, t, r) {
      if (e.sseEvent) dt(n, r, e.sseEvent);
        ...
        if (!Qe(e, Lt("load", { elt: n }))) pt(n, r, t, e.delay);
    ...
    function Ot(e) {
      ...
      if (t) {
        ...
        for (var l in r) Rt(e, l, r[l]);
      }
    }
    function qt(t) {
      if (t.closest && t.closest(z.config.disableSelector)) return;
      var r = Y(t);
      if (r.initHash !== Ce(t)) {
        r.initHash = Ce(t);
        Re(t);
    ...
    function ie(e, t, r) {
      ...
      r["elt"] = e;
      var n = Lt(t, r);
      if (z.logger && !At(t)) z.logger(e, t, r);
      if (r.error) {
        x(r.error);
    ...
    function Xt(e) {
      ...
      if (z.config.historyEnabled) history.pushState({ htmx: true }, "", e);
      Nt = e;
    }
    function Ft(e) {
    ...
    function jt(a) {
      ...
      e.onload = function() {
        ...
        } else ne(J().body, "htmx:historyCacheMissLoadError", o);
      };
      e.send();
    }
    function Ut(e) {
    ...
    function zt(e) {
      ...
      if (
        e.type === "button" || e.type === "submit" || e.tagName === "image" || e.tagName === "reset"
        || e.tagName === "file"
      ) return false;
      ...
      if (zt(e)) {
        ...
        if (a != null && o != null) {
          ...
          if (s !== undefined) {
            ...
            } else {if (Array.isArray(o)) r[a] = [s].concat(o);
              else r[a] = [s, o];}
          } else r[a] = o;
        }
        if (i) Gt(e, n);
    ...
    function Qt(e, t, r) {
      ...
      if (Y(e).boosted) n["HX-Boosted"] = "true";
      return n;
    }
    function er(t, e) {
      var r = Z(e, "hx-params");
    ...
    function rr(e, t) {
      ...
      if (Y(e).boosted && !tr(e)) n["show"] = "top";
      if (r) {
        var i = M(r);
        if (i.length > 0) {
          n["swapStyle"] = i[0];
          for (var a = 1; a < i.length; a++) {
            ...
            if (o.indexOf("transition:") === 0) n["transition"] = o.substr(11) === "true";
    ...
    function ar(e, t) {
      ...
      if (t.scroll) {
        var i = null;
        if (t.scrollTarget) i = re(r, t.scrollTarget);
        if (t.scroll === "top" && (r || i)) {
          i = i || r;
          i.scrollTop = 0;
        }
    ...
    function dr(e, t, r) {
      ...
      if (r) {
        ...
        } else {return ae(e, t, s(r.source), r.event, {
            handler: r.handler,
            headers: r.headers,
            values: r.values,
      ...
      } else return ae(e, t, null, null, { returnPromise: true });
    }
    function vr(e) {
      var t = [];
      while (e) {
    ...
    function ae(e, t, n, r, i, M) {
      ...
      if (!M) {
        ...
        if (ie(n, "htmx:confirm", F) === false) return;
      }
      var u = n;
      var f = Y(n);
      var c = Z(n, "hx-sync");
      ...
      if (c) {
        var v = c.split(":");
        var g = v[0].trim();
        if (g === "this") u = he(n, "hx-sync");
        else u = re(n, g);
        c = (v[1] || "drop").trim();
        f = Y(u);
        if (c === "drop" && f.xhr && f.abortable !== true) return;
        else if (c === "abort") {
          if (f.xhr) return;
          else d = true;
        } else if (c === "replace") ie(u, "htmx:abort");
      ...
      if (f.xhr) {
        if (f.abortable) ie(u, "htmx:abort");
        else {
          if (h == null) {
            if (r) {
              var p = Y(r);
              if (p && p.triggerSpec && p.triggerSpec.queue) h = p.triggerSpec.queue;
            }
            if (h == null) h = "last";
          }
      ...
      var S = Qt(n, l, b);
      if (i.headers) S = te(S, i.headers);
      var E = Jt(n, e);
      var C = E.errors;
      var R = E.values;
      if (i.values) R = te(R, i.values);
      var j = fr(n);
      var O = te(R, j);
      var q = er(O, n);
      if (e !== "get" && !nr(n)) S["Content-Type"] = "application/x-www-form-urlencoded";
      if (z.config.getCacheBusterParam && e === "get") q["org.htmx.cache-buster"] = $(l, "id") || "true";
      ...
      if (e === "get") {
        ...
        m.open("GET", N, true);
      } else m.open(e.toUpperCase(), t, true);
    ...
    function pr(s, l) {
      ...
      if (E(u, /HX-Trigger:/i)) De(u, "HX-Trigger", s);
      ...
      if (E(u, /HX-Retarget:/i)) l.target = J().querySelector(u.getResponseHeader("HX-Retarget"));
      var h = gr(s, l);
      ...
      if (i.shouldSwap) {
        ...
        if (E(u, /HX-Reswap:/i)) a = u.getResponseHeader("HX-Reswap");
        var c = rr(s, a);
        ...
        if (c.hasOwnProperty("transition")) p = c.transition;
      ...
      if (n) {
        ne(
          s,
          "htmx:responseError",
          te({ error: "Response Status Error Code " + u.status + " from " + l.pathInfo.requestPath }, l),
        );
      }
    }
    var mr = {};
    ...
    function Er() {
      if (z.config.includeIndicatorStyles !== false) {
        J().head.insertAdjacentHTML(
          "beforeend",
          "<style>                      ." + z.config.indicatorClass
            + "{opacity:0;transition: opacity 200ms ease-in;}                      ." + z.config.requestClass + " ."
            + z.config.indicatorClass + "{opacity:1}                      ." + z.config.requestClass + "."
            + z.config.indicatorClass + "{opacity:1}                    </style>",
        );
      }
    }
    function Cr() {
      var e = J().querySelector("meta[name=\"htmx-config\"]");
      if (e) return y(e.content);
      else return null;
    }
    function Rr() {
      var e = Cr();
      if (e) z.config = te(z.config, e);
    }
    Sr(function() {
      Rr();
      Er();
